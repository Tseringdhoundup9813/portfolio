      ...
      <div className="contact-main-wrapper">
        ...
        <div className="contact-parent-detail-wrapper">
          ...
          <div className="contact-map-section">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d28255.156832353616!2d85.27934334977893!3d27.7205402577202!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb189021984781%3A0xc02431dabe5b419d!2sSwayambhu%20Buddha%20Park%20-%20Ring%20Road!5e0!3m2!1sen!2snp!4v1713081135854!5m2!1sen!2snp"
              width="100%"
              height="200"
              style={{ border: 0 }}
              allowfullscreen=""
          ...
          <div className="socail-medai-link-container">
            <Link href="https://www.facebook.com/tsering.dhoundup.39">
              <FaFacebook className="social-icon" />
            </Link>
            <Link href="https://www.linkedin.com/in/tsering-dhoundup-lama-12204618b/">
              <FaLinkedin className="social-icon" />
            </Link>
            <Link href="https://github.com/Tseringdhoundup9813">
        ...
        <form onSubmit={ContactFormHandler} className="contact-form-container">
          ...
          <div>
            <div>
              ...
              />
              {nameError && <p className="error">Name is required field!</p>}
            </div>
            <div>
              ...
              />
              {emailError && <p className="error">Email is required field!</p>}
            </div>
          </div>
